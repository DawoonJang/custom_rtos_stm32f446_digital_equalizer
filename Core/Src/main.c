...
static void MX_GPIO_Init(void)
{
	 ...
	 HAL_GPIO_WritePin(GPIOC, TFT_RST_Pin | TFT_RS_Pin | TFT_LED_Pin | LED7_Pin, GPIO_PIN_RESET);

	 /*Configure GPIO pins : TFT_RST_Pin TFT_RS_Pin TFT_LED_Pin LED7_Pin */
	 GPIO_InitStruct.Pin	  = TFT_RST_Pin | TFT_RS_Pin | TFT_LED_Pin | LED7_Pin;
